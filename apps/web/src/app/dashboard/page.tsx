      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-8">
          <div className="bg-white shadow-lg rounded-lg p-6">
            <h2 className="text-xl font-semibold text-secondary-900 mb-4">User Information</h2>
            <div className="space-y-3">
              ...
              <div>
                ...
                <span className="ml-2 text-secondary-600">{user.firstName} {user.lastName}</span>
              </div>
              <div>
                <span className="font-medium text-secondary-700">Role:</span>
                <span className="ml-2 text-secondary-600 capitalize">{user.role}</span>
              </div>
              <div>
                <span className="font-medium text-secondary-700">Email Verified:</span>
          ...
          <div className="bg-white shadow-lg rounded-lg p-6">
            <h2 className="text-xl font-semibold text-secondary-900 mb-4">Permissions</h2>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {hasPermission(PERMISSIONS.ASSESSMENTS_CREATE) && (
              <button className="btn-primary p-4 text-left">
                ...
                <div className="text-sm opacity-90">Create a new business assessment</div>
              </button>
            )}
            ...
            {hasPermission(PERMISSIONS.ASSESSMENTS_READ) && (
              <button className="btn-secondary p-4 text-left">
                ...
                <div className="text-sm opacity-90">Browse existing assessments</div>
              </button>
            )}
            ...
            {hasPermission(PERMISSIONS.COMPANY_UPDATE) && (
              <button className="btn-secondary p-4 text-left">
                ...
                <div className="text-sm opacity-90">Manage company information</div>
              </button>
            )}
