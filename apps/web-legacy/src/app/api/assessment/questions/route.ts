...
export async function GET(_request: NextRequest) {
  try {
    ...
    const questionDatabase = {
      'strategic-alignment': [
          ...
          followUpQuestions: [
            {
              ...
              required: false,
              conditional: { dependsOn: '1.1', showIf: ['Unclear - significant variations in interpretation', 'No clear vision - leadership gives contradictory answers'] }
            }
          ]
        },
        {
          ...
          followUpQuestions: [
            {
              id: '1.2-followup-1',
              type: 'text',
              question: 'What drives resource allocation decisions when strategy isn\'t considered?',
              required: false,
              conditional: { dependsOn: '1.2', showIf: ['Rarely - decisions made mostly on operational needs', 'Never - strategic priorities don\'t influence day-to-day resource allocation'] }
            }
          ]
        },
        {
        ...
        },
        {
          id: '1.8',
          type: 'multiple-choice',
          question: 'How effectively does your organization turn regulatory requirements into competitive advantages?',
          options: [
            'Expert level - compliance capabilities become market differentiators',
            'Advanced level - regulatory expertise creates business opportunities',
            'Competent level - compliance handled efficiently without strategic benefit',
            'Basic level - compliance managed but not leveraged strategically',
            'Struggling - compliance seen only as cost and constraint'
          ],
          required: false,
          industrySpecific: {
            regulated: true
      ...
      'operational-excellence': [
        ...
        },
        {
          id: '4.8',
          type: 'multiple-choice',
          question: 'How well integrated and optimized is your supply chain management?',
          options: [
            'Fully integrated - end-to-end supply chain visibility with automated optimization',
            'Well integrated - good supply chain coordination with regular optimization',
            'Partially integrated - basic supply chain management with some coordination',
            'Limited integration - poor supply chain coordination creating inefficiencies',
            'Fragmented - supply chain operates with minimal integration or optimization'
          ],
          required: false,
          industrySpecific: {
            businessModel: ['Manufacturing', 'Physical Products']
          }
        }
      ],
      ...
      'people-organization': [
        ...
        },
        {
          ...
          required: false,
          conditional: {
            dependsOn: 'growth-rate',
            showIf: ['50%+ headcount growth in past year']
          }
        }
      ],
      ...
      'technology-data': [
        ...
        },
        {
          id: '6.8',
          type: 'multiple-choice',
          question: 'How scalable and maintainable is your core product technology architecture?',
          options: [
            'Excellent architecture - highly scalable, maintainable architecture supporting rapid feature development',
            'Good architecture - solid architecture with good scalability and maintainability',
            'Adequate architecture - architecture works but has some scalability or maintainability limitations',
            'Poor architecture - significant architectural debt affecting development speed and scalability',
            'Legacy architecture - architectural problems significantly limiting business growth'
          ],
          required: false,
          industrySpecific: {
            businessModel: ['B2B SaaS', 'Technology']
          }
        }
      ],
      ...
      'customer-experience': [
        ...
        },
        {
          id: '7.7',
          type: 'multiple-choice',
          question: 'How well do you personalize customer experiences at scale?',
          options: [
            'Advanced personalization - sophisticated, data-driven personalization creating competitive advantage',
            'Good personalization - effective personalization enhancing customer experience',
            'Basic personalization - some personalization efforts with limited impact',
            'Minimal personalization - limited personalization mainly for basic segmentation',
            'No personalization - one-size-fits-all approach to customer experience'
          ],
          required: true
        },
        {
          id: '7.8',
          type: 'multiple-choice',
          question: 'How effectively do you measure and optimize customer lifetime value?',
          options: [
            'Advanced CLV optimization - sophisticated CLV modeling driving business decisions',
            'Good CLV tracking - solid CLV measurement with regular optimization efforts',
            'Basic CLV awareness - understand CLV concept but limited systematic optimization',
            'Limited CLV understanding - minimal CLV tracking or optimization',
            'No CLV focus - decisions made without systematic CLV consideration'
          ],
          required: true
        }
      ],
      ...
      'supply-chain': [
        ...
        },
        {
          ...
          required: false,
          industrySpecific: {
            businessModel: ['International Supply Chain']
          }
        }
      ],
      ...
      'risk-compliance': [
        ...
        },
        {
          id: '9.8',
          type: 'multiple-choice',
          question: 'How comprehensively do you manage operational risks specific to your industry?',
          options: [
            'Industry-leading risk management - operational risk management creates competitive advantages',
            'Strong operational risk management - comprehensive approach with regular monitoring',
            'Adequate operational risk management - key operational risks managed effectively',
            'Limited operational risk management - operational risks not comprehensively managed',
            'Poor operational risk management - operational risk exposures threatening business'
          ],
          required: false,
          industrySpecific: {
            businessModel: ['High-Risk Industry']
          }
        }
      ],
      ...
      'partnerships': [
        ...
        },
        {
          id: '10.7',
          type: 'multiple-choice',
          question: 'How strategic and effective are your technology integration partnerships?',
          options: [
            'Strategic integration ecosystem - integration partnerships create significant competitive moats',
            'Strong integration partnerships - effective integrations providing customer value',
            'Basic integrations - standard integrations meeting customer needs',
            'Limited integrations - integration partnerships not effectively leveraged',
            'Poor integration strategy - missing integration opportunities or poorly executed partnerships'
          ],
          required: false,
          industrySpecific: {
            businessModel: ['Technology', 'Software']
          }
        }
      ],
      ...
      'customer-success': [
        ...
        },
        {
          id: '11.8',
          type: 'multiple-choice',
          question: 'How effective is your customer onboarding in driving time-to-value and long-term success?',
          options: [
            'Exceptional onboarding - systematic onboarding driving rapid value realization and high satisfaction',
            'Strong onboarding - effective onboarding with good customer success outcomes',
            'Adequate onboarding - basic onboarding meeting customer expectations',
            'Poor onboarding - onboarding gaps affecting customer satisfaction and success',
            'Broken onboarding - onboarding problems creating customer satisfaction and retention issues'
          ],
          required: false,
          industrySpecific: {
            businessModel: ['Subscription', 'SaaS']
      ...
      'change-management': [
        ...
        },
        {
          ...
          options: [
            ...
            'Change-averse - organization resists change making growth initiatives very difficult'
          ],
          required: true
        },
        {
          id: '12.8',
          type: 'multiple-choice',
          question: 'How effectively do you manage technology and system changes?',
          options: [
            'Technology change excellence - systematic technology change management with high success rates',
            'Good technology change management - effective technology updates with minimal disruption',
            'Adequate technology change management - technology changes managed with some challenges',
            'Poor technology change management - technology changes often create operational problems',
            'Chaotic technology changes - technology changes regularly disrupt business operations'
          ],
          required: true
        }
      ]
    ...
    return NextResponse.json(questionDatabase, {
      headers: {
